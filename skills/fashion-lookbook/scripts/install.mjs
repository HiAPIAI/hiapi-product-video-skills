...
const SKILL_FOLDER = "hiapi-fashion-lookbook-video";
const REPO_URL = "https://github.com/HiAPIAI/hiapi-fashion-lookbook-video-skill.git";
const DISPLAY_NAME = "HiAPI Fashion Lookbook Video Skill";
...
async function resolveTargets() {
  if (forceCodex && forceClaude) throw new Error("Choose either --codex or --claude, not both.");
...
function installTo(target) {
  ...
  try {
    ...
    for (const required of ["SKILL.md", "package.json", "scripts/hiapi-fashion-lookbook-video.mjs"]) {
